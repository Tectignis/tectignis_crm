...
if(isset($_GET['gen'])){
      ...
      $sql=mysqli_query($conn,"update quotation set `status`='1'");
      if($sql==1){
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Quotation Table</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.html">Home</a>
                                    </li>
                                    <li class="breadcrumb-item active">Quotation Table
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="product.php"><button type="button" id="view" button class="dt-button create-new btn btn-primary">
                                          + Add New Quotation
                                          </button></a>
                            </div>
                        ...
                        $sql=mysqli_query($conn,"select * from quotation where status=0");
                        $count=1;
                        ...
                        ?>
                                        ...
                                        <td> </td>
                                         <td>
                                         <button type="button" data-id="<?php echo $arr['id'] ?>"  class="btn-sm btn-outline-primary view" data-bs-toggle="modal" data-bs-target="#addNewCard" >
                    <i data-feather="eye"></i>
                                    </button>


                    <!-- <input type="submit" class="delete-row btn-sm btn-outline-primary" value="PDF Send" /><?php echo $message; ?>
                    <i data-feather="phone"></i>
                    </button> -->

                    <form method="post">
    <input type="submit" name="action" class="btn btn-outline-primary" value="PDF Send" /><?php echo $message; ?>
   </form>

                    <button type="button" class="delete-row btn-sm btn-outline-primary">
                    <i data-feather="file-text"></i>
                  
                    </button>

                    <button type="button" id="usereditid" class="delete-row btn-sm btn-outline-primary">
                    <i data-feather="mail"></i>
                    </button>

                    <a href="quotation.php?gen=<?php echo $row['id'];?>">
                    <button class="btn-sm btn-outline-primary" name="submit">Sales</button>
                    </button>
                  </td>
                                        </tr>
                                        <?php $count++;  } ?>
