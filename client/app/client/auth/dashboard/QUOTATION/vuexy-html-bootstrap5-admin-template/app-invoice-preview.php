                ...
                <section class="invoice-preview-wrapper">
                    <div class="row invoice-preview">
                        ...
                        ?>
                                                ...
                                                <p class="invoice-date"><?php echo $arr['date'];?></p>
                                            </div>
                                            <?php } ?>
                        ...
                        ?>
                                        <div class="col-xl-8 p-0">
                                            ...
                                            <p class="card-text mb-25"><?php echo $arr['customer'];?></p>
                        ...
                        ?>
                                            <tr>
                                            <td class="py-1">
                                                    <p class="card-text fw-bold mb-25"><?php echo $arr['product_name'];?></p>
                                                    <p class="card-text text-nowrap"><?php echo $arr['description'];?></p>
                                                </td>
                                                <td class="py-1">
                                                    <span class="fw-bold"><?php echo $arr['price'];?></span>
                                                </td>
                                                <td class="py-1">
                                                    <span class="fw-bold"><?php echo $arr['quantity'];?></span>
                                                </td>
                                                <td class="py-1">
                                                    <span class="fw-bold"><?php echo $arr['total'];?></span>
                                                </td>
                                            </tr>
                        ...
                        ?>
                                        <div class="col-12" style="padding-bottom:20px;">
                                            <span class="fw-bold"><strong>Description:</strong></span>
                                            <span><?php echo $arr['description'];?>!</span>
                                        </div>
                        
                                        <div class="col-12">
                                            <span class="fw-bold"><strong>Terms And Condition:</strong></span>
                                            <span><?php echo $arr['terms'];?>!</span>
                                        </div>
                                        <?php } ?>
                                    </div>
                                </div>
