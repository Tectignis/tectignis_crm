...
if(isset($_POST['submit'])){
  ...
  if($sql==1){
    echo "<script>alert('Register successfully'),window.location='condition.php';</script>";
  }else{
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Terms And Condition</h2>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="mb-1">
                                                <form method="post">
                                                <label class="form-label" for="exampleFormControlTextarea1">Terms And Condition</label>
                                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Type here" name="terms"></textarea>
