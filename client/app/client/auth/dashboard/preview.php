            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i
                    ...
                    <ul class="menu-content">
                        ...
                        <li class="active"><a class="d-flex align-items-center" href="app-invoice-preview.html"><i
                                    data-feather="circle"></i><span class="menu-item text-truncate"
                                ...
                                <div class="card-body invoice-padding pb-0">
                                    ...
                                    <div
                                        ...
                                        <div class="mt-md-0 mt-2">
                                            <?php
                                            $sql=mysqli_query($conn,"select * from preview");
                                           
                                            while ($row=mysqli_fetch_array($sql)){ 
                                        ?>
                                            <h4 class="invoice-title">
                                                Invoice
                                                <span class="invoice-number"><?php echo $row['invoice_code']; ?></span>
                                            </h4>
                                            <div class="invoice-date-wrapper">
                                                <p class="invoice-date-title">Date Issued:</p>
                                                <p class="invoice-date"><?php echo $row['date_issued']; ?></p>
                                            </div>
                                            <div class="invoice-date-wrapper">
                                                <p class="invoice-date-title">Due Date:</p>
                                                <p class="invoice-date"><?php echo $row['due_date']; ?></p>
                                            </div>
                                            <?php } ?>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body invoice-padding pt-0">
                                    <div class="row invoice-spacing">
                                        ...
                                        <div class="col-xl-8 p-0">
                                            ...
                                            <h6 class="mb-25"><?php echo $row['name']; ?></h6>
                                            <p class="card-text mb-25"><?php echo $row['adress']; ?></p>
                                            <p class="card-text mb-25"><?php echo $row['number']; ?></p>
                                            <p class="card-text mb-0"><?php echo $row['gmail']; ?></p>
                                        </div>
                                            ...
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><span
                                                                class="fw-bold"><?php echo $row['total_due']; ?></span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                            ...
                                            <tr>
                                                <td class="py-1">
                                                    ...
                                                    <p class="card-text text-nowrap">
                                                        <?php echo $row['title_native']; ?>
                                                    </p>
                                                </td>
                                                <td class="py-1">
                                                    <span class="fw-bold"><?php echo $row['rate']; ?></span>
                                                </td>
                                                <td class="py-1">
                                                    <span class="fw-bold"><?php echo $row['hours']; ?></span>
                                                </td>
                                                <td class="py-1">
                                                    <span class="fw-bold"><?php echo $row['task_total']; ?></span>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                        ...
                                        <div class="col-md-6 d-flex justify-content-end order-md-2 order-1">
                                            <div class="invoice-total-wrapper">
                                                <div class="invoice-total-item">
                                                    ...
                                                    <p class="invoice-total-amount"><?php echo $row['subtotal']; ?></p>
                                                </div>
                                                <div class="invoice-total-item">
                                                    <p class="invoice-total-title">Discount:</p>
                                                    <p class="invoice-total-amount"><?php echo $row['discount']; ?></p>
                                                </div>
                                                <div class="invoice-total-item">
                                                    <p class="invoice-total-title">Tax:</p>
                                                    <p class="invoice-total-amount"><?php echo $row['tax']; ?></p>
                                                </div>
                                                <hr class="my-50" />
                                                <div class="invoice-total-item">
                                                    <p class="invoice-total-title">Total:</p>
                                                    <p class="invoice-total-amount"><?php echo $row['total']; ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <?php } ?>
                        ...
                        <div class="col-xl-3 col-md-4 col-12 invoice-actions mt-md-0 mt-2">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <button
                                        class="btn btn-outline-secondary w-100 btn-download-invoice mb-75">Download</button>
