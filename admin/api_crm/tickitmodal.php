...
if(isset($_GET['delid'])){
  ...
  if($sql=1){
      header("location:../tickitmodal.php");
  }
  }
            ...
            <tr>
                ...
                <td style="text-align:center"><?php
                   ...
                   <button class="btn btn-primary btn-rounded btn-icon setting dnkediti" data-id='<?php echo $row['id']; ?>'><i class="fas fa-wrench"></i></button>
                     <a href="../tickitmodal.php?delid=<?php echo $row['id']; ?>"><button type="button" class="btn btn-danger btn-rounded btn-icon"> <i class="fas fa-trash"></i> </button></a> </td>
                  </tr>
                  <?php $count++; } ?>
