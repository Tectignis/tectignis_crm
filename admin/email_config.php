            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Email Config</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Email Config
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <ul class="nav nav-pills mb-2">
                            ...
                            <!-- connection -->
                            <li class="nav-item">
                                <a class="nav-link active" href="email_config.php">
